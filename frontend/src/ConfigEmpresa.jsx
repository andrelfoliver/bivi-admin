...
const translations = {
  ...
  en: {
    ...
    solicitacaoEmailPlaceholder: "E.g., Before we say goodbye, may I send more details by email? What is your email?",
    ...
    exemplosAtendimentoPlaceholder: "Enter examples of questions and answers for service",
  },
};
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <main style={{ flexGrow: 1, backgroundColor: '#f5fafd', padding: '2rem' }}>
        ...
        >
          {/* Título principal */}
          <h2 style={{ textAlign: 'center', marginBottom: '2rem', color: '#272631' }}>
          ...
          <Tabs activeKey={activeTab} onSelect={(k) => setActiveTab(k)} className="mb-3">
            ...
            <Tab eventKey="instrucao" title={t.instrucoesPersonalizadas}>
              ...
              {/* Botão Salvar Configuração aparece apenas nesta última aba */}
              <button
                type="submit"
                style={{
